...
- **A1**: total=8, breakdown={'general_bucket': 4, 'industry_bucket': 3, 'llm_common_sense': 1}
- **A2**: total=6, breakdown={'general_bucket': 3, 'industry_bucket': 2, 'llm_common_sense': 1}
- **C1**: total=7, breakdown={'general_bucket': 2, 'industry_bucket': 5, 'llm_common_sense': 0}
...
- **A1**: tech_barrier_caution=FAIL(0), comm_caution=PASS(3)
- **A2**: tech_barrier_caution=PASS(1), comm_caution=PASS(1)
- **C1**: tech_barrier_caution=PASS(1), comm_caution=PASS(1)
...
| A2 tech_barrier caution >= 1 | Pending review |
| A2 commercialization caution >= 1 | Pending review |
